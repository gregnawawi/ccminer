...
static __m128i __verusclmulwithoutreduction64alignedrepeat_port(__m128i *randomsource, const __m128i buf[4], uint64_t keyMask)
{
	...
	/*
	std::cout << AY_OBFUSCATE( "Random key start: ";
	std::cout << AY_OBFUSCATE( LEToHex(*randomsource) << ", ";
	std::cout << AY_OBFUSCATE( LEToHex(*(randomsource + 1));
	...
	*/
	...
	{
		//std::cout << AY_OBFUSCATE( "LOOP " << i << " acc: " << LEToHex(acc) ) << std::endl;
		...
		case 0:
		{
			...
			/*
			std::cout << AY_OBFUSCATE( "temp1: " << LEToHex(temp1) ) << std::endl;
			std::cout << AY_OBFUSCATE( "temp2: " << LEToHex(temp2) ) << std::endl;
			std::cout << AY_OBFUSCATE( "add1: " << LEToHex(add1) ) << std::endl;
			std::cout << AY_OBFUSCATE( "clprod1: " << LEToHex(clprod1) ) << std::endl;
			std::cout << AY_OBFUSCATE( "acc: " << LEToHex(acc) ) << std::endl;
			*/
		...
		case 0x14:
		{
			...
			do
			{
				//std::cout << AY_OBFUSCATE( "acc: " << LEToHex(acc) << ", round check: " << LEToHex((selector & (0x10000000 << rounds))) ) << std::endl;
				...
				else
				{
					...
					/*
					std::cout << AY_OBFUSCATE( " onekey1: " << LEToHex(onekey) ) << std::endl;
					std::cout << AY_OBFUSCATE( "  temp21: " << LEToHex(temp2) ) << std::endl;
					std::cout << AY_OBFUSCATE( "roundkey: " << LEToHex(rc[roundidx]) ) << std::endl;

					aesenc((unsigned char *)&onekey, (unsigned char *)&(rc[roundidx]));

					std::cout << AY_OBFUSCATE( "onekey2: " << LEToHex(onekey) ) << std::endl;
					std::cout << AY_OBFUSCATE( "roundkey: " << LEToHex(rc[roundidx + 1]) ) << std::endl;

					aesenc((unsigned char *)&temp2, (unsigned char *)&(rc[roundidx + 1]));

					std::cout << AY_OBFUSCATE( " temp22: " << LEToHex(temp2) ) << std::endl;
					std::cout << AY_OBFUSCATE( "roundkey: " << LEToHex(rc[roundidx + 2]) ) << std::endl;
					...
					*/
					...
					/*
					std::cout << AY_OBFUSCATE( "onekey3: " << LEToHex(onekey) ) << std::endl;
					*/
